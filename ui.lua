...
local Library = {
    ...
    BackgroundColor = Color3.fromRGB(8, 8, 8);    -- Near-black bg
    AccentColor = Color3.fromRGB(255, 145, 0);    -- Orange/gold accent
    OutlineColor = Color3.fromRGB(32, 32, 32);    -- Subtle outline
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        SatVibMap.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                ...
                while (Input.UserInputType == Enum.UserInputType.Touch and dragging) or (Input.UserInputType ~= Enum.UserInputType.Touch and InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1)) do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        SliderInner.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
                ...
                while (isTouch and dragging) or (not isTouch and InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1)) do
                    local nMPos = Mouse.X;
