...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        DividerLine = New("Frame", {
            BackgroundColor3 = "OutlineColor",
            Position = UDim2.fromOffset(0, 0),
            Size = UDim2.new(0, 0, 0, 0), -- hidden, kept for compat
            Parent = MainFrame,
            Visible = false,
        })
        ...
        --// Sidebar Logo/Title area (draggable)
        ...
        New("UIListLayout", { Parent = CurrentTabInfo })
        ...
        local AvatarImg = New("ImageLabel", {
            BackgroundTransparency = 1,
            Image = string.format("rbxthumb://type=AvatarHeadShot&id=%s&w=48&h=48", tostring(LocalPlayer.UserId)),
            Size = UDim2.fromScale(1, 1),
            ZIndex = 5,
            Parent = AvatarFrame,
        })
        ...
        New("UICorner", { CornerRadius = UDim.new(0, 3), Parent = BadgeLabel })
    ...
    function Window:AddTab(...)
        ...
        do
            -- Sidebar button (full width, vertical layout)
            ...
            -- Left accent bar (shown when active, like the image)
            ...
            TabLabel = New("TextLabel", {
                AnchorPoint = Vector2.new(0, 0.5),
                BackgroundTransparency = 1,
                Position = Icon and UDim2.new(0, 24, 0.5, 0) or UDim2.new(0, 0, 0.5, 0),
                Size = UDim2.new(1, Icon and -24 or 0, 0, 20),
                Text = Name,
        ...
        function Tab:Hover(Hovering)
            ...
            TweenService:Create(TabButton, Library.TweenInfo, {
                BackgroundColor3 = Hovering and Color3.fromRGB(30, 30, 30) or Color3.fromRGB(15, 15, 15),
                BackgroundTransparency = Hovering and 0 or 1,
            }):Play()
            TweenService:Create(TabLabel, Library.TweenInfo, {
                TextColor3 = Hovering and Color3.new(1, 1, 1) or Color3.fromRGB(180, 180, 180),
                TextTransparency = 0,
            }):Play()
            if TabIcon then
                TweenService:Create(TabIcon, Library.TweenInfo, {
                    ImageColor3 = Hovering and Color3.new(1, 1, 1) or Color3.fromRGB(200, 200, 200),
                    ImageTransparency = 0,
                }):Play()
            end
        end
        ...
        function Tab:Show()
            ...
            -- Active: dark red tint background like the image
            TweenService:Create(TabButton, Library.TweenInfo, {
